<?php
namespace Magento\Developer\Model\Config\Backend\WorkflowType;

/**
 * Interceptor class for @see \Magento\Developer\Model\Config\Backend\WorkflowType
 */
class Interceptor extends \Magento\Developer\Model\Config\Backend\WorkflowType implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\App\Config\ScopeConfigInterface $config, \Magento\Framework\App\Cache\TypeListInterface $cacheTypeList, \Magento\Framework\App\State\CleanupFiles $cleaner, \Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, \Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $cleaner, $resource, $resourceCollection, $data);
    }
