<?php
namespace Magento\Developer\Model\Config\Backend\AllowedIps;

/**
 * Interceptor class for @see \Magento\Developer\Model\Config\Backend\AllowedIps
 */
class Interceptor extends \Magento\Developer\Model\Config\Backend\AllowedIps implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $messageManager, $escaper, $resource, $resourceCollection, $data);
    }
