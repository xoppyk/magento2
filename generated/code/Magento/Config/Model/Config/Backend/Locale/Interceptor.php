...
/**
 * Interceptor class for @see \Magento\Config\Model\Config\Backend\Locale
 */
class Interceptor extends \Magento\Config\Model\Config\Backend\Locale implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $configsFactory, $websiteFactory, $storeFactory, $localeCurrency, $resource, $resourceCollection, $data);
    }
