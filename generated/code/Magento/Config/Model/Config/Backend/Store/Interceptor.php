<?php
namespace Magento\Config\Model\Config\Backend\Store;

/**
 * Interceptor class for @see \Magento\Config\Model\Config\Backend\Store
 */
class Interceptor extends \Magento\Config\Model\Config\Backend\Store implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $mutableConfig, $resource, $resourceCollection, $data);
    }
