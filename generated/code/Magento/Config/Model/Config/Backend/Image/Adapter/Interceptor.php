<?php
namespace Magento\Config\Model\Config\Backend\Image\Adapter;

/**
 * Interceptor class for @see \Magento\Config\Model\Config\Backend\Image\Adapter
 */
class Interceptor extends \Magento\Config\Model\Config\Backend\Image\Adapter implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $imageFactory, $resource, $resourceCollection, $data);
    }
