<?php
namespace Magento\Config\Model\Config\Backend\Admin\Usecustom;

/**
 * Interceptor class for @see \Magento\Config\Model\Config\Backend\Admin\Usecustom
 */
class Interceptor extends \Magento\Config\Model\Config\Backend\Admin\Usecustom implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $configWriter, $resource, $resourceCollection, $data);
    }
