<?php
namespace Magento\Config\Model\Config\Backend\Baseurl;

/**
 * Interceptor class for @see \Magento\Config\Model\Config\Backend\Baseurl
 */
class Interceptor extends \Magento\Config\Model\Config\Backend\Baseurl implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $mergeService, $resource, $resourceCollection, $data);
    }
