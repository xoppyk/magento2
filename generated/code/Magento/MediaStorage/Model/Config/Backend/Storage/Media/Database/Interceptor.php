<?php
namespace Magento\MediaStorage\Model\Config\Backend\Storage\Media\Database;

/**
 * Interceptor class for @see \Magento\MediaStorage\Model\Config\Backend\Storage\Media\Database
 */
class Interceptor extends \Magento\MediaStorage\Model\Config\Backend\Storage\Media\Database implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\App\Config\ScopeConfigInterface $config, \Magento\Framework\App\Cache\TypeListInterface $cacheTypeList, \Magento\MediaStorage\Helper\File\Storage $coreFileStorage, \Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, \Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $coreFileStorage, $resource, $resourceCollection, $data);
    }
